        ...
        <section>
            <div class="row d-flex align-items-center justify-content-center">
                <div class="col-md-8 d-flex align-items-center justify-content-center content mx-auto">
                    <p class="bg-primary p-2">Sửa Khoản Chi Tiêu</p>
                </div>
            </div>
            <div class="container">
            <div class="row mt-4" id="kq">
                <div class="col-md-8 offset-md-2">
                    <div class="card mb-4">
                    <div class="card-body">
                        <h5 class="card-title">Hạng Mục: Con Cái</h5>
                        <h5 class="card-title">Số Tiền: 12 000 000</h5>
                        <h5 class="card-title">Loại Tài Khoản: Thẻ</h5>
                        <h5 class="card-title">Thời Gian: 14/12/2023</h5>
                        <p class="card-text"></p>
                    </div>
            </div>
